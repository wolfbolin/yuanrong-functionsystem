...
EXTERNALPROJECT_ADD(${src_name}
        SOURCE_DIR ${src_dir}
        DOWNLOAD_COMMAND ""
        CONFIGURE_COMMAND env LDFLAGS=${LINK_SAFE_FLAGS} CFLAGS=${THIRDPARTY_C_FLAGS} CXXFLAGS=${${src_name}_CXX_FLAGS} ./autogen.sh ${JEMALLOC_PROF_FLAGS} --prefix=<INSTALL_DIR>
        LOG_CONFIGURE ON
        LOG_BUILD ON
        LOG_INSTALL ON
        BUILD_IN_SOURCE 1
