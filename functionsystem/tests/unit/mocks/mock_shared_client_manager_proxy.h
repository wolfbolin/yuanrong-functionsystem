...
class MockSharedClientManagerProxy : public PosixStreamManagerProxy {
public:
    MockSharedClientManagerProxy() : PosixStreamManagerProxy(litebus::AID())
    {
    }
    ~MockSharedClientManagerProxy() = default;

    MOCK_METHOD(litebus::Future<std::shared_ptr<DataInterfacePosixClient>>, GetDataInterfacePosixClient,
                (const std::string &instanceID), (override));

    MOCK_METHOD(litebus::Future<std::shared_ptr<DataInterfacePosixClient>>, NewDataInterfacePosixClient,
